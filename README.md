...
# Scribbly - Stationery E-Commerce Web App

Welcome to Scribbly, a beautifully crafted e-commerce platform offering a seamless shopping experience for stationery. This project is built using **React.js** and **Firebase**, delivering a delightful UI/UX and mobile-friendly experience for all users.
...
<img src="screenshots/1.png" alt="Scribbly Home Page - Main Landing Page" width="100%" style="max-width: 900px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); margin: 20px 0;">
...
**Live Demo:** [Scribbly.pages.dev](https://Scribbly.pages.dev)
...
1. **Clone the Repository**
   ...
   ```bash
   git clone https://github.com/swastikChamp2/Scribbly.git
   cd Scribbly
   ```
