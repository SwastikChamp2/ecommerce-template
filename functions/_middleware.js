...
function generateMetaTags(product, url) {
  const metaDescription = product.description
    ...
    : `Buy ${product.name} online at Scribbly`;

  const title = `${product.name} | Scribbly - Premium Stationery`;
  ...
  return `
    ...
    <meta property="og:site_name" content="Scribbly - Premium Stationery">
    ...
    <meta name="twitter:site" content="@Scribbly">
