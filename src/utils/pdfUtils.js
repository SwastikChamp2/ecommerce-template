...
// Import shop logo
import logoImage from '../assets/logo-transparent-darkish-logo-for-better-visibility.png';
    ...
    ">
      ...
      ">
        ...
        <div class="brand-section" style="
          ...
          gap: 14px;
        ">
          <img src="${logoImage}" alt="Scribbly Logo" style="
            width: 52px;
            height: 52px;
            border-radius: 10px;
      ...
      `${order.shipping.address.houseNo ? order.shipping.address.houseNo + ', ' : ''}
        ...
        ">
          ...
          ">From</h3>
          <div style="color: #1d1d1f; font-size: 11px; line-height: 1.5;">
            <div style="font-weight: 600; margin-bottom: 4px;">Scribbly Stationeries Pvt. Ltd.</div>
            <div style="color: #86868b; margin-bottom: 2px;">North Sentinel Island, Andaman and Nicobar Islands, India</div>
            <div style="color: #86868b; margin-bottom: 2px;">support@Scribbly.nsi</div>
      ...
      ">
        <h3 style="
          ...
          margin: 0 0 8px 0;
          letter-spacing: -0.2px;
        ">Thank you for your order at Scribbly!</h3>
        <p style="
          font-size: 10px;
          color: #86868b;
          margin: 0;
...
export const downloadOrderReceipt = async (order) => {
  try {
    ...
    await generatePdfFromElement('temp-receipt-container', `Scribbly-Invoice-${order.orderId}`);
