...
import { Mail, ArrowRight, Loader2, CheckCircle2, Link2 } from "lucide-react";
...
function SignIn() {
  ...
  const handlePasswordlessSignIn = async () => {
    ...
    try {
      ...
      console.error("Error with passwordless sign-in:", error);
    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to your Scribbly account</p>
        </div>
          ...
          {!emailSent ? (
            <>
              ...
              <div className="space-y-3">
                ...
                {/* Passwordless Sign In — separated with its own divider */}
                ...
                {!email && (
                  <p className="text-xs text-center text-gray-400">Enter your email above to use passwordless sign in</p>
                )}
              </div>
            </>
          ) : (
